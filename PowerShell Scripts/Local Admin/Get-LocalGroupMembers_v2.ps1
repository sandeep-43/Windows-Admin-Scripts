...
$computers = gc $env:USERPROFILE\Documents\servers.txt
foreach($computer in $computers)
{
    Get-LocalGroupMembers -ComputerName $computer | Out-File  $env:USERPROFILE\Documents\CHLT_Output_Recheck2.txt -append #| Export-csv $env:USERPROFILE\Documents\CHLT_Output.csv -append -NotypeInformation
}
