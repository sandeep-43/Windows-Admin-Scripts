...
function Get-RSMAlertInfo{
    ...
    [Parameter()]
    [string]$ErrorLogFilePath="$env:USERPROFILE\Documents\LogFiles\RSMAlertErrorLogFile.txt",

    [Parameter()]
    [string]$LogFilePath="$env:USERPROFILE\Documents\Log Files\RSMAlertLogFile.txt",
