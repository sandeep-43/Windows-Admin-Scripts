$Hosts = Get-Content -Path "$env:USERPROFILE\Documents\servers_2008R2.txt" #"Path of the text file containing server names" 
$ErrorLogFilePath = "C:\Temp\WinUpdate\Copy_Logs_Server2008R2.txt" 
