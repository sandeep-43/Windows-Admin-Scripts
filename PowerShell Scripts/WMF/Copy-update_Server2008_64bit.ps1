$Hosts = Get-Content -Path "$env:USERPROFILE\Documents\servers_2008_64bit.txt" #"Path of the text file containing server names" 
$ErrorLogFilePath = "C:\Temp\WinUpdate\Copy_Logs_Server200_64bit.txt" 
