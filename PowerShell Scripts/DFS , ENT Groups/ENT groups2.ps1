...
#$RootPath = Read-Host 'Enter \\ServerName\Sharename '
 $RootPath = gc $env:USERPROFILE\Documents\abc.txt
 foreach ($RoothP in $RootPath)
 {  
Write-host " "
Write-host " "
Write-host "     Processing NTFS Permissions for $RootP"
Write-host " "
Write-host " "

$Date = (Get-Date -format "dd-MM-yyyy---HH-mm")

$Servername = $RootP.split("\")
...
$Folders = dir $RootP -Recurse -ErrorAction SilentlyContinue | where {$_.PsIsContainer} 
